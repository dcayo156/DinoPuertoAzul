...
Public Class R_FacturaPrueba
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_FacturaPrueba.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FacturaPrueba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FacturaPrueba = New R_FacturaPrueba()
        rpt.Site = Me.Site
        Return rpt
    End Function
