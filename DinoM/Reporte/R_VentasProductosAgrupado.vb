...
Public Class R_VentasProductosAgrupado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_VentasProductosAgrupado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_VentasProductosAgrupado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VentasProductosAgrupado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VentasProductosAgrupado = New R_VentasProductosAgrupado()
        rpt.Site = Me.Site
        Return rpt
    End Function
