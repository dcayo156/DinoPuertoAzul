...
Public Class R_FacturaFarmacia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_FacturaFarmacia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TotalEscrito() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_FacturaFarmacia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FacturaFarmacia = New R_FacturaFarmacia()
        rpt.Site = Me.Site
        Return rpt
    End Function
