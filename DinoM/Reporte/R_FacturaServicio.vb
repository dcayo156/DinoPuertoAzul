...
Public Class R_FacturaServicio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_FacturaServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FacturaServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FacturaServicio = New R_FacturaServicio()
        rpt.Site = Me.Site
        Return rpt
    End Function
